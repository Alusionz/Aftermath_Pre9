...
object_draft_schematic_weapon_lightsaber_lightsaber_one_hand_gen1 = object_draft_schematic_weapon_lightsaber_shared_lightsaber_one_hand_gen1:new {
   ...
   resourceTypes = {"mineral", "object/tangible/component/weapon/lightsaber/lightsaber_module_force_crystal.iff" or "lightsaber_module_krayt_dragon_pearl.iff", "metal", "chemical", "gas", "metal"},
